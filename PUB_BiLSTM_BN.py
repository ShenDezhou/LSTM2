...
UNIGRAM = 'msr_dic/msr_dict.utf8'
BIGRAM = 'msr_dic/msr_bigram.utf8'
...
if __name__ == "__main__":
    ...
    msrTEST = 'plain/msr_test.utf8'
    l.info("inference msrtest:")
    with codecs.open(msrTEST, 'r', encoding='utf8') as fr:
        segs = bilstm.cut(fr.readlines())
    l.info("inference msrtest done.")
    print(segs)